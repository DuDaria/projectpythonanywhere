...
urlpatterns = [
    ...
    path('post/<int:post_id>/review/', views.ReviewCreateView.as_view(), name='review'),
    ...
    path('<int:user_id>/profile/reviews/', views_auth.profile_review, name='profile_review'),
    path('<int:user_id>/profile/message_to/', views_auth.MessageToProfileView.as_view(), name='message_to_profile'),
    path('<int:user_id>/profile/review_to/', views_auth.review_to_profile, name='review_to_profile'),
